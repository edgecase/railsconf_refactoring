...
CREATE TABLE "rolls" ("id" INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, "score" integer, "unused" integer, "action" varchar(255), "turn_id" integer, "position" integer, "created_at" datetime, "updated_at" datetime);
